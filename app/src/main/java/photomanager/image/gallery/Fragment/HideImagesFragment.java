package photomanager.image.gallery.Fragment;


import static photomanager.image.gallery.Activity.MainActivity.imgUnlock;
import static photomanager.image.gallery.Activity.MainActivity.imgselectall;
import static photomanager.image.gallery.Activity.MainActivity.llSelectedOptions;
import static photomanager.image.gallery.Activity.MainActivity.relSelection;
import static photomanager.image.gallery.Activity.MainActivity.txtSelectedTitle;
import static photomanager.image.gallery.MyApplication.HiddenImages;
import static photomanager.image.gallery.MyApplication.allimages;
import static photomanager.image.gallery.MyApplication.isEnteredPwd;
...
import photomanager.image.gallery.Activity.MainActivity;
import photomanager.image.gallery.Activity.SplashActivity;
import photomanager.image.gallery.Activity.ViewImageActivity;
import photomanager.image.gallery.Adhelper.InterAds;
import photomanager.image.gallery.Adhelper.LargeNativeAds;
import photomanager.image.gallery.Helper.GridRecyclerView;
import photomanager.image.gallery.Helper.Utils;
import photomanager.image.gallery.MyApplication;
import photomanager.image.gallery.R;
import photomanager.image.gallery.library.ViewAnimator.ViewAnimator;
import photomanager.image.gallery.stickyheader.StickyHeaders;
